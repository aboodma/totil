        ...
        <div class="row">
            ...
            <div class="col-lg-8 right">
                ...
                <div class="p-4 bg-white rounded shadow-sm mb-3">
                    ...
                    <div class="row ">
                        <div class="col-md-12  ">
                           <form action="{{route('provider.books.service.update',$book->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                               ...
                               <div class="form-group">
                                   ...
                                   <textarea name="description" class="form-control" cols="30" rows="5">{{$book->description}}</textarea>
                               </div>
                               <div class="row">
                                   <div class="col-md-4">
                                    <div class="form-group">
                                   ...
                                   <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="pages_count" value="{{$book->pages_count}}" class="form-control">
                                    </div>
                                   </div>
                               </div>
                               <div class="form-group">
