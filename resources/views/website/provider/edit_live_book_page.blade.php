            ...
            <div class="row">
                ...
                <div class="col-lg-8 right">
                    ...
                    <div class="p-4 bg-white rounded shadow-sm mb-3">
                        ...
                        <div class="row ">
                            <div class="col-md-12  ">
                                <form method="post" action="{{route('provider.update_live_book_page',$liveBookPage->id)}}" enctype="multipart/form-data">

                                    @csrf

                                    <div class="form-group">
                                        <label for="">Book Description</label>
                                        <textarea name="content" class="form-control" id="editor" cols="30" rows="20" >{{$liveBookPage->content}}</textarea>
                                    </div>
