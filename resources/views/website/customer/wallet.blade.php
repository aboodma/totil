                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button data-toggle="modal" data-target="#exampleModal" type="button"
                                        class="btn btn-success float-right"><i class="fas fa-plus"></i> Add Funds To
                                    wallet
                                </button>
                            </div>
                        </div>
                                    ...
                                    <table class="table ">
                                        ...
                                        @foreach($wallets as $wallet)
                                            <tr>
                                                ...
                                                <td class="text-success">@if($wallet->transaction_type == 0) + @else
                                                        - @endif {{$wallet->amount}} USD
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-left-0">
                                                <b>{{auth()->user()->wallets->where('transaction_type',0)->sum('amount') - auth()->user()->wallets->where('transaction_type',1)->sum('amount')}}
                                                    USD</b></td>
                                        </tr>
                                        </tfoot>
                                    </table>
