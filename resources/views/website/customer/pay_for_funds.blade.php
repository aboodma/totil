    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-1">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{route('customer.payFunds')}}" method="POST">
                            <input type="hidden" name="funds" value="{{$request->funds}}">
                            ...
                            <hr>
                                ...
                                <div class="row justify-content-between form-group ml-1 mr-1 mb-0">
                                    <h5><b>{{__('Total')}}</b></h5>
                                    <h5><b>{{$request->funds + 10}} USD</b></h5>
                                </div>
