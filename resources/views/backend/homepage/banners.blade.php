...
<a href="{{route('admin.homepage.banners.create')}}" class="btn btn-sm btn-primary font-weight-bolder text-uppercase">Create Banner</a>
            ...
            <table class="table table-bordered table-checkable" id="kt_datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <div class="btn-group">
                            <form action="{{route('admin.homepage.banners.destroy',$banner->id)}}" method="POST">
